        ...
        <div className="section-frame relative overflow-hidden rounded-[1.75rem] border border-warning/14 bg-[linear-gradient(155deg,rgba(247,210,30,0.07),rgba(11,11,15,0.96))] p-6 sm:p-8">
          <div className="grid gap-10 lg:grid-cols-[1.25fr_0.75fr_0.8fr]">
            <div className="space-y-3">
              <p className="display-kicker text-ash">{siteConfig.shortName}</p>
              <p className="body-copy max-w-md">{siteConfig.manifesto.statement}</p>
              <p className="micro-copy text-warning/80">{siteConfig.manifesto.support}</p>
            </div>

            <div className="space-y-3">
              <p className="meta-label text-warning">Navigate</p>
            ...
            <div className="space-y-3">
              <p className="meta-label text-warning">Contact + Social</p>
              <p className="body-copy text-ash/75">{siteConfig.email}</p>
