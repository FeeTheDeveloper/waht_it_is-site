    ...
    >
      ...
      <div className="relative space-y-4">
        <div className={`relative overflow-hidden rounded-[1.3rem] border border-ash/16 bg-ink/65 ${isFeature ? "p-4 sm:p-5" : "p-3 sm:p-4"}`}>
          <div className="eyebrow-chip absolute left-3 top-3 z-10 border-warning/45 bg-ink/85 text-warning">
            {product.badge}
          </div>
          ...
          <div className="mt-4 flex items-end justify-between gap-3">
            <div>
              ...
              <p className={`${isFeature ? "meta-value-accent" : "display-kicker text-warning"} mt-1`}>{product.price}</p>
            </div>
            <span className="eyebrow-chip border-ash/12 bg-black/35 text-ash/74">
        ...
        <div className="space-y-3 px-1 pb-1">
          <div className="space-y-2">
            <h3 className={`${isFeature ? "display-callout" : "display-card"} text-ash`}>
              {product.name}
            </h3>
            <p className={`${isFeature ? "body-lead" : "body-copy"} text-ash/76`}>{product.description}</p>
          </div>
          <div className="flex flex-wrap gap-2">
            ...
            {product.colorways.length ? (
              <span className="eyebrow-chip border-warning/16 bg-warning/8 text-warning/84">
          ...
          <div className="flex flex-col gap-3 pt-1 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
            ...
            <p className="micro-copy">Secure Shopify checkout</p>
          </div>
        </div>
      </div>
    </article>
